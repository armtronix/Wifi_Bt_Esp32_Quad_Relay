  ...
  if(Serial.available())
             {
              ...
              if(serialReceived.substring(0,3)=="R10")
              {  
               ...
               if(serialReceived.substring(0,3)=="R11")
              {
               ...
               if(serialReceived.substring(0,3)=="R20")
              {
               ...
               if(serialReceived.substring(0,3)=="R21")
              {
               ...
               if(serialReceived.substring(0,3)=="R30")
              {
               ...
               if(serialReceived.substring(0,3)=="R31")
              {
                ...
                if(serialReceived.substring(0,3)=="R40")
              {
               ...
               if(serialReceived.substring(0,3)=="R41")
              {
...
void display_Rlystatus() 
{

    if(digitalRead(OUTPIN_04) != relay1pinstatus )
     {
//      /Serial.println("R1:"+String(digitalRead(OUTPIN_04)));
            Serial.write("sleep=0");
            Serial.write(0xFF);
            Serial.write(0xFF);
            Serial.write(0xFF);
            delay(2);
      if(digitalRead(OUTPIN_04) == HIGH)
      {
       Serial.write("bt0.val=1");
       Serial.write(0xFF);
       Serial.write(0xFF);
       Serial.write(0xFF);
      }
      else if(digitalRead(OUTPIN_04) == LOW)
       {
       Serial.write("bt0.val=0");
       Serial.write(0xFF);
       Serial.write(0xFF);
       Serial.write(0xFF);
       }
     }
     relay1pinstatus = digitalRead(OUTPIN_04);
//--------------------------------------------------------------
      if(digitalRead(OUTPIN_12) != relay2pinstatus )
     {
//      /Serial.println("R2:"+String(digitalRead(OUTPIN_12)));
           Serial.write("sleep=0");
           Serial.write(0xFF);
           Serial.write(0xFF);
           Serial.write(0xFF);
           delay(2);
      if(digitalRead(OUTPIN_12) == HIGH)
      {
       Serial.write("bt1.val=1");
       Serial.write(0xFF);
       Serial.write(0xFF);
       Serial.write(0xFF);
      }
      else if(digitalRead(OUTPIN_12) == LOW)
       {
       Serial.write("bt1.val=0");
       Serial.write(0xFF);
       Serial.write(0xFF);
       Serial.write(0xFF);
       }
     }
     relay2pinstatus = digitalRead(OUTPIN_12);
//--------------------------------------------------------------

      if(digitalRead(OUTPIN_13) != relay3pinstatus )
     {
//      /Serial.println("R3:"+String(digitalRead(OUTPIN_13)));
           Serial.write("sleep=0");
           Serial.write(0xFF);
           Serial.write(0xFF);
           Serial.write(0xFF);
           delay(2);
      if(digitalRead(OUTPIN_13) == HIGH)
      {
       Serial.write("bt2.val=1");
       Serial.write(0xFF);
       Serial.write(0xFF);
       Serial.write(0xFF);
      }
      else if(digitalRead(OUTPIN_13) == LOW)
       {
       Serial.write("bt2.val=0");
       Serial.write(0xFF);
       Serial.write(0xFF);
       Serial.write(0xFF);
       }
     }
     relay3pinstatus = digitalRead(OUTPIN_13);
//--------------------------------------------------------------

      if(digitalRead(OUTPIN_14) != relay4pinstatus )
     {
//      /Serial.println("R4:"+String(digitalRead(OUTPIN_14)));
            Serial.write("sleep=0");
            Serial.write(0xFF);
            Serial.write(0xFF);
            Serial.write(0xFF);
            delay(2);
       if(digitalRead(OUTPIN_14) == HIGH)
      {
       Serial.write("bt3.val=1");
       Serial.write(0xFF);
       Serial.write(0xFF);
       Serial.write(0xFF);
      }
      else if(digitalRead(OUTPIN_14) == LOW)
       {
       Serial.write("bt3.val=0");
       Serial.write(0xFF);
       Serial.write(0xFF);
       Serial.write(0xFF);
       }
     }
     relay4pinstatus = digitalRead(OUTPIN_14);
}
